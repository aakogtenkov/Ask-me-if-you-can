...
В рамках проекта была создана, обучена и протестирована нейронная сеть, генерирующая ответ по тексту и вопросу. Обучение и тестирование происходило на bAbI-задании. А именно, были выбраны 16 из 20 заданий bAbI-task'a, и была обучена нейронная сеть, способная отвечать на все эти 16 типов вопросов. Качество сети на отложенной выборке составило более 90%. 
