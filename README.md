...
В самом начале необходимо скачать код проекта askme.py из этого репозитория и файлы test.txt, test_network.index, test_network.meta, test_network.data-00000-of-00001. Перейдем в папку с кодом и файлами и запустим приложение с помощью консольной команды
