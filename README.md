...
Вначале входной текст кодируется как последовательность векторов, каждый вектор кодирует одно слово текста или символ окончания предложения. Эта последовательность подается на вход рекуррентной сети GRU, которая преобразовывает эти векторы в новую последовательность. 
...
Поздравляем! Вы прошли данный туториал до конца и более чем две трети освоили возможности пользовательского интерфейса и приложения в целом! Чтобы выйти из программы, можно ввести
